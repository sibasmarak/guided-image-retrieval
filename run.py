...
if __name__ == "__main__":
	...
	parser.add_argument('--vision_learning_rate', default = 1e-5, type = float)
	...
	parser.add_argument('--load_cache', default = False, type = bool)
	...
	if args.train:
		...
		train_dataloader = DataLoader(train_data, batch_size=args.batch_size, num_workers = args.num_workers, collate_fn=train_data.collater)
	...
	if args.validation:
		validation_data = ImageCaptionDataset(args.dataset, language_model_name = args.language_model_name, preprocess_text = args.preprocess_text, 
								...
								image_resize = args.image_resize, warn_grayscale = args.warn_grayscale)
		validation_dataloader = DataLoader(validation_data, batch_size=args.batch_size, num_workers = args.num_workers, collate_fn=validation_data.collater)
	...
	if args.test:
		test_data = ImageCaptionDataset(args.dataset, language_model_name = args.language_model_name, preprocess_text = args.preprocess_text, 
								...
								image_resize = args.image_resize, warn_grayscale = args.warn_grayscale)
		test_dataloader = DataLoader(test_data, batch_size=args.batch_size, num_workers = args.num_workers, collate_fn=test_data.collater)
